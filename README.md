...
Fetches your most recent submission via the LeetCode GraphQL API
Checks if the submission status is Accepted
Retrieves the actual submitted code along with runtime and memory stats
Sends the code to GPT for a senior engineer-style review
Emails the analysis report directly to you
...
Import leetcode_analyzer.json into your n8n instance
...
Update the LeetCode username variable in the first HTTP Request node
Activate the workflow — it runs on a schedule automatically
